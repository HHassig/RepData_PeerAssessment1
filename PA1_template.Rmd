...
- Interval with maximum number of steps: `r maximumInterval`
...
```
- Imputed Mean: `r imputedDailyStepsMean`
- Imputed Median:  `r imputedDailyStepsMedian`
- Mean: `r dailyMean`
- Median is `r dailyMedian`.  
